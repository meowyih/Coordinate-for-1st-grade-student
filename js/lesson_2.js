...
// change index div color
for ( i = 2; i <= 9; i ++ )
{
	document.getElementById( "area" + 1 + i ).style.backgroundColor = "#F5B041";
}

for ( i = 2; i <= 6; i ++ )
{
	document.getElementById( "area" + i + 1 ).style.backgroundColor = "#E74C3C";
}
...
function onclickx() {
	...
	document.getElementById( g_oldxy ).src = "./image/airplane.png";
}
